...
export function getOffersColumns(t: TFunction): ColumnDef<JobOffer>[] {
  return [
    ...
    {
      id: 'details',
      header: t('offerte.table.details'),
      cell: ({ row, table }) => {
        const offer = row.original
        const meta = table.options.meta as OffersTableMeta
        ...
        return (
          <div className="text-sm">
            <div className="text-muted-foreground truncate">{offer.location || t('offerte.locationUnknown')}</div>
    ...
    {
      id: 'actions',
      header: t('offerte.table.actions'),
      cell: ({ row, table }) => {
        const offer = row.original
        const meta = table.options.meta as OffersTableMeta
