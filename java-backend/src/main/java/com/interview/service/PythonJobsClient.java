...
@Service
public class PythonJobsClient {

    private final RestClient pythonAiRestClient;
    private final ObjectMapper objectMapper;

    public PythonJobsClient(RestClient pythonAiRestClient, ObjectMapper objectMapper) {
    ...
    public String getHtml(Integer userId, String path, String queryParam, String queryValue) {
        String uri = UriComponentsBuilder.fromPath("/api/internal/jobs" + path)
